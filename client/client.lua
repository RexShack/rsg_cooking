	...
	exports['qbr-core']:TriggerCallback('QBCore:HasItem', function(hasItem) 
		if hasItem then
			exports['qbr-core']:Progressbar("cook_steak", "Cooking Meat Steak..", 30000, false, true, {
				...
				exports['qbr-core']:Notify(9, 'You cooked a Meat Steak', 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
			end)
		else
			exports['qbr-core']:Notify(9, 'You don\'t have the ingredients to make this!', 5000, 0, 'mp_lobby_textures', 'cross', 'COLOR_RED')
		end
	end, { ['raw_meat'] = 1 })
end)
	...
	exports['qbr-core']:TriggerCallback('QBCore:HasItem', function(hasItem) 
		if hasItem then
			exports['qbr-core']:Progressbar("fish_steak", "Cooking Fish Steak..", 30000, false, true, {
				...
				exports['qbr-core']:Notify(9, 'You cooked a Fish Steak', 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
			end)
		else
			exports['qbr-core']:Notify(9, 'You don\'t have the ingredients to make this!', 5000, 0, 'mp_lobby_textures', 'cross', 'COLOR_RED')
		end
	...
	exports['qbr-core']:TriggerCallback('QBCore:HasItem', function(hasItem) 
		if hasItem then
			exports['qbr-core']:Progressbar("process_small_fish", "Processing Fish..", 10000, false, true, {
				...
				exports['qbr-core']:Notify(9, 'fish ready for cooking', 5000, 0, 'hud_textures', 'check', 'COLOR_WHITE')
			end)
		else
			exports['qbr-core']:Notify(9, 'You don\'t have the items to do this', 5000, 0, 'mp_lobby_textures', 'cross', 'COLOR_RED')
		end
