	...
	exports['qbr-core']:TriggerCallback('QBCore:HasItem', function(hasItem) 
		if hasItem then
			exports['qbr-core']:Progressbar("cook_steak", "Cooking Meat Steak..", 30000, false, true, {
				...
				exports['rsg_notify']:DisplayNotification('You cooked a Meat Steak', 5000)
			end)
		else
	...
	exports['qbr-core']:TriggerCallback('QBCore:HasItem', function(hasItem) 
		if hasItem then
			exports['qbr-core']:Progressbar("fish_steak", "Cooking Fish Steak..", 30000, false, true, {
				...
				exports['rsg_notify']:DisplayNotification('You cooked a Fish Steak', 5000)
			end)
		else
			--exports['rsg_notify']:DisplayNotification('You don\'t have the ingredients to make this!', 5000)
			TriggerEvent('rsg_notify:client:bottom_notifiy', 'You don\'t have the ingredients to make this!', 5000)
		end
	end, { ['fishmeat'] = 1 })
end)
	...
	exports['qbr-core']:TriggerCallback('QBCore:HasItem', function(hasItem) 
		if hasItem then
			exports['qbr-core']:Progressbar("process_small_fish", "Processing Fish..", 10000, false, true, {
				...
				exports['rsg_notify']:DisplayNotification('fish ready for cooking', 5000)
			end)
		else
			TriggerEvent('rsg_notify:client:bottom_notifiy', 'You don\'t have the items to do this', 5000)
		end
